...
RFC_FUNCTION_DESC_HANDLE createDescription(void){
    ...
    RFC_PARAMETER_DESC REQUTEXT = { { iU("REQUTEXT") }, RFCTYPE_CHAR, RFC_IMPORT, 255, 510, 0, 0, { 0 }, { 0 }, 0, 0 };
	RFC_PARAMETER_DESC ECHOTEXT = { { iU("ECHOTEXT") }, RFCTYPE_CHAR, RFC_EXPORT, 255, 510, 0, 0, { 0 }, { 0 }, 0, 0 };
	RFC_PARAMETER_DESC RESPTEXT = { { iU("RESPTEXT") }, RFCTYPE_CHAR, RFC_EXPORT, 255, 510, 0, 0, { 0 }, { 0 }, 0, 0 };
